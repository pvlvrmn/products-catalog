  ...
  return (
    <div className={`product__wrapper ${!isMenuShow ? 'product__wrapper__wide' : 'product__wrapper__narrow'}`}>
      ...
      <div className='product__info'>
        <Text style={{display: 'block', padding: '10px 0 5px 0'}} variant='display-3'>{product.title}</Text>
        <Text style={{display: 'block', padding: '0 0 10px 0'}} variant='subheader-1'>{product.brand}</Text>
        <div className='product__rating'>
          <StarFill/>
          <Text style={{display: 'block', padding: '0 0 10px 0'}} variant='body-2'>{product.rating}</Text>
        </div>
        <Text style={{display: 'block', padding: '0 0 20px 0'}} variant='body-3'>{product.description}</Text>
        <div className='product__price'>
          <Text style={{display: 'block', padding: '0 0 0px 0'}} variant='display-3'>$ {product.price}</Text>
